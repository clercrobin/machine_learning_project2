...
def loadTrainTest(interval, xTrain, xTest):
	...
	#y_train1,y_test1 = pickle.load(open('.pierre/pickles/cnn_embeddings_1_output.pickle','rb'))
	#y_train2,y_test2 = pickle.load(open('.pierre/pickles/cnn_embeddings_2_output.pickle','rb'))
	i=0
	for x in interval:
